...
?>
<body>
<form name="frmseller" action="sellerinsert.php" method="post">
<blockquote>&nbsp;	</blockquote>
<table width="317" border="1">
  <tr>
    <td colspan="2"><div align="center">Seller Detail </div></td>
  </tr>
  ...
  <tr>
    <td><div align="center">Area Id</div></td>
	<td>
	<select name="drparea">
		...
		<?php
			...
			{
				echo "<option value='".$row["areaid"]."'>".$row["areaid"]."</option>";
			}
		?>
    </select>
  </tr>
  <tr>
    <td><div align="center">City Id</div></td>
	<td>
	<select name="drpcity">
		<option value="0">-Select-</option>
		<?php
  ...
  <tr>
    <td><div align="center">State Id</div></td>
	<td>
	<select name="drpstate">
		...
		<?php
			...
			while($row = mysql_fetch_array($res))
			{
				echo "<option value='".$row["stateid"]."'>".$row["stateid"]."</option>";
			}
		?>
    </select>
  <tr>
    <td><div align="center">Pincod</div></td>
    <td><input type="text" name="txtpincod" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="radio" name="gender" valu.e="male" />Male<input type="radio" name="gender" value="female" />Female</td>
  </tr>
  <tr>
  <td >
    ...
    <tr>
  	<td colspan="2"><?php include("sellergrid.php"); ?></td>
  </tr>
