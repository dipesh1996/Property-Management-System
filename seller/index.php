...
<div id="content-wrap"> <img src="images/headerphoto.jpg" alt="headerphoto" class="no-border" height="200" width="1024" />
<div id="sidebar">
...
$res = mysql_query($query);
while($row = mysql_fetch_array($res))
{echo "<p><img src='../projectimage/".$row["projectimage"]."' height='200px' width='350px' alt=''/></p>";}
?>
</div>
