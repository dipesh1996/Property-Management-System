...
$query = "update tblseller set firstname='".$_REQUEST["txtfirstname"]."',lastname='".$_REQUEST["txtlastname"]."',address='".$_REQUEST["txtaddress"]."',areaid=".$_REQUEST["drparea"].",cityid=".$_REQUEST["drpcity"].",stateid=".$_REQUEST["drpstate"].",pincode=".$_REQUEST["txtpincode"].",email='".$_REQUEST["txtemail"]."',mobile=".$_REQUEST["txtmobile"].",gender='".$_REQUEST["rbgender"]."' where loginid=".$_SESSION["loginid"];
mysql_query($query);
