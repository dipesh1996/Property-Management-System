...
<div class="form-group has-success"> 
          <label for="lastname" class="col-md-4 control-label">Property For:</label> 
	       <div class="col-sm-5"> 
...
<div class="form-group has-success"> 
     <label for="lastname" class="col-md-4 control-label">Bedroom: </label> 
	   <div class="col-sm-5"> 
         <input type="text" class="form-control" name="txttotalbedroom" placeholder="Enter Bedroom" required>
       </div>
	  </div>
<div class="form-group has-success"> 
     <label for="lastname" class="col-md-4 control-label">Bathroom: </label> 
	   <div class="col-sm-5"> 
