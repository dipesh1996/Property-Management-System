...
?>
<body>
<form  name="frmbrokerregistration" method="post" action="index.php?page=brokerregistrationconfirm.php"onsubmit="return validate();" class="form-horizontal" role="form">
   <h3 align="center">Broker Registration</h3><hr />
  ...
  <div class="form-group has-success"> 
	  ...
	  <div class="form-group has-success"> 
	   ...
	   <div class="form-group has-success"> 
          <label for="lastname" class="col-md-3 control-label">Fax: </label> 
	       <div class="col-sm-5"> 
             <input type="text" class="form-control" name="txtfax" placeholder="Enter Fax" maxlength="10" required>
	       </div>
	   </div>
    ...
    <h4 style="padding:10px 20px;">Login Details...</h4>
	    <div class="form-group has-success"> 
