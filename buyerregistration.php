...
?>
<body>
<form  name="frmbrokerregistration" method="post" action="index.php?page=buyerregistrationconfirm.php"onsubmit="return validate();" class="form-horizontal" role="form">
   <h3 align="center">Buyer Registration</h3><hr />
