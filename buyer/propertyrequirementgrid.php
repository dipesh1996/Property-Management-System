...
if(isset($_REQUEST["reqid"]))
{
	...
	mysql_query($query);
	echo "<script>alert('requirement deleted.');document.location='index.php?page=propertyrequirement.php';</script>";
}
$query = "select * from tblpropertyrequirement where loginid=".$_SESSION["loginid"];
