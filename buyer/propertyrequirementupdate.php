...
if(isset($_REQUEST["Submit"]))
{
	$query = "update tblpropertyrequirement set  minimumarea=".$_REQUEST["txtminimumarea"].",maximumarea=".$_REQUEST["txtmaximumarea"].",minimumprice=".$_REQUEST["txtminimumprice"].",maximumprice=".$_REQUEST["txtmaximumprice"].",furniture='".$_REQUEST["txtfurniture"]."',requirementfor='".$_REQUEST["rbfor"]."',typeid=".$_REQUEST["drptype"].",totalbedroom=".$_REQUEST["txttotalbedroom"].",totalbathroom=".$_REQUEST["txttotalbathroom"]." where requirementid=".$_REQUEST["txtrequirementid"];
		mysql_query($query);
		echo "<script>alert('Requirement updated');document.location='index.php?page=propertyrequirement.php';</script>";
}
...
?>
<body>
<form class="form-horizontal" name="frmpropertyrequirementupdate" action="#" method="post">
<h3 align="center">Property Requirement Update Details...</h3><hr /> 
    
	<div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Requirement Id:</label> 
       <div class="col-sm-5"> 
	 ...
	 <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Minimum Area:</label> 
       <div class="col-sm-5"> 
	 ...
	 <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Maximum Area:</label> 
       <div class="col-sm-5"> 
	 ...
	 <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Minimum Price:</label> 
       <div class="col-sm-5"> 
	   ...
	   <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Maximum Price:</label> 
       <div class="col-sm-5"> 
	 ...
	 <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Furniture:</label> 
       <div class="col-sm-5"> 
    ...
    <div class="form-group has-success" align="center">
     <label for="firstname" class="col-md-5 control-label" >Requirement For:</label> 
       <div class="col-sm-5">
           	<?php
   ...
   <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Total bedroom:</label> 
       <div class="col-sm-5"> 
        ...
        <div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >Total bathroom:</label> 
       <div class="col-sm-5"> 
