...
<!-- content-wrap starts here -->
	<div id="content-wrap"> 
	    <img src="images/headerphoto.jpg" alt="headerphoto" class="no-border" height="200" width="1024px" />
	<div id="sidebar">
		<h4 align="center">Broker Control</h4>
			<ul class="sidemenu">
			<li><a href="index.php?page=home.php">Home</a></li>
			<li><a href="index.php?page=brokerprofile.php">Profile</a></li>
			
			<li><a href="index.php?page=postproperty.php">Property</a></li>
			<li><a href="index.php?page=propertyrequirement.php">Requirement</a></li>
...
{echo "<p><img src='../propertyimage/".$row["images"]."' height='200px' width='250px' alt=''/></p>";}
?>
</div>
