...
?>
<body>
<form class="form-horizontal" name="frmpostproperty" method="post" enctype="multipart/form-data" action="" onSubmit="return validate();">
<h3 align="center">Property Update Details...</h3><hr />
<div class="form-group has-success" align="center"> 
     <label for="firstname" class="col-md-5 control-label" >I D:</label> 
       <div class="col-sm-5"> 
...
<div class="form-group has-success"> 
     <label for="lastname" class="col-md-5 control-label">Adress: </label> 
	   <div class="col-sm-5"> 
         <textarea class="form-control" name="txtaddress"  required><?php echo $row["address"];  ?></textarea>
	   </div> 
  </div>
   ...
   <div class="form-group has-success"> 
     <label for="lastname" class="col-md-5 control-label">Pincode: </label> 
	   ...
	   <div class="form-group has-success"> 
          <label for="lastname" class="col-md-5 control-label">Plotarea: </label> 
	       <div class="col-sm-5"> 
	   ...
	   <div class="form-group has-success"> 
          <label for="lastname" class="col-md-5 control-label">Carpatarea: </label> 
	       <div class="col-sm-5"> 
		...
		<div class="form-group has-success"> 
          <label for="lastname" class="col-md-5 control-label">Builduparea: </label> 
	       <div class="col-sm-5"> 
	 ...
	 <?php include("postpropertygrid.php"); ?></td>
